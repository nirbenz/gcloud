...
This tutorial goes through how to set up your own Google Compute Engine (GCE) instance to work on the assignments. Each student will have $1000 in credit throughout the course, thanks to Gogole Israel's generousity.
